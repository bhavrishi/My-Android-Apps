...
public class DisplayAdapter  extends ArrayAdapter<Movie> {
    SharedPreferencesFavourites sharedPreference; Date date;

    public DisplayAdapter(Context mcontext, ArrayList<Movie> mlist) {
