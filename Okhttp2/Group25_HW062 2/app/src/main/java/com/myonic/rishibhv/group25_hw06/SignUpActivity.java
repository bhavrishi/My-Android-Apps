...
EditText dob; int mYear,mMonth,mDay;          DatePickerDialog mDatePicker;    Calendar myCalendar;
    EditText email,fname,lname,pwd1,pwd2; Button submit,btnCancel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit= (Button) findViewById(R.id.btnfinish);
...
submit.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        int yearBirthday = myCalendar.get(Calendar.YEAR);
        int years = yearNow - yearBirthday;
        Log.d("demoyears",""+yearNow+yearBirthday+years);
        ...
        {
            Toast.makeText(SignUpActivity.this,"Age should be minimum 13",Toast.LENGTH_SHORT).show();
        }
