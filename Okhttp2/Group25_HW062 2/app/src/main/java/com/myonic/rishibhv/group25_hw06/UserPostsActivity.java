    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        friendsTab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent tabIntent = new Intent(UserPostsActivity.this,FriendsTabActivity.class);
...
//       Log.d("uname",uname);
            outUname.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(UserPostsActivity.this, ProfileDisplay.class);
                    i.putExtra(NAME, uname);
                    i.putExtra(UID, id_main);
                    startActivity(i);
