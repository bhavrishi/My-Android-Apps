...
public class WalfSelfAdapter extends RecyclerView.Adapter<WalfSelfAdapter.ViewHolder> {
    private ArrayList<Post> mdata;
    UserPostsActivity context;

    public WalfSelfAdapter(UserPostsActivity context, ArrayList<Post> mdata) {
        this.mdata = mdata;
...
/*MessageThreadAdapter(ArrayList<Course> mdata, DBManager dm) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_wall_list, parent, false);
...
holder.deleteimg.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        context.callDeleteMethod(post.getId(),position);
    }
});
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, Context context) {
            ...
            deleteimg= (ImageView) itemView.findViewById(R.id.imageView4);
        }
