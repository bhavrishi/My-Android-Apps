...
public class AsyncTaskSimilarJSON extends AsyncTask<String, Void, ArrayList<Track>> {


  //  AsyncTaskJSON.AsyncResponse delegate;
    ...
    public AsyncTaskSimilarJSON(Context applicationContext) {
    ...
    protected ArrayList<Track> doInBackground(String... strings) {
        ...
        try {
            ...
            if (statuscpde == HttpURLConnection.HTTP_OK) {
                ...
                //    Thread.sleep(2000);
                return SimilarUtil.TriviaJSONParser.parseQuestions(sb.toString());
