...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //final String[] str = {"EBook", "Sherlock"};
...
//                        progressBar.setProgress((int)message.obj);
                        break;
...
//                        progressBar.setProgress((int)message.obj);
                    ...
                    case DoWork.PROCESS_END:
                        ...
                        if (processCount == str.length) {
                            Intent intent = new Intent(MainActivity.this, ResultsDisplay.class);
    ...
    class DoWork implements Runnable{
        ...
        //public DoWork(String[] strings, int checkcase){
