...
public class AsyncTaskJSON extends AsyncTask<String, Void, ArrayList<Itunes>> {
    ...
    public AsyncTaskJSON(Context applicationContext) {
    ...
    @Override
    protected void onPostExecute(ArrayList<Itunes> track) {
    ...
    protected ArrayList<Itunes> doInBackground(String... strings) {
        ...
        try {
            ...
            if (statuscpde == HttpURLConnection.HTTP_OK) {
                ...
                //    Thread.sleep(2000);
                return ItunesUtil.TriviaJSONParser.parseQuestions(sb.toString());
