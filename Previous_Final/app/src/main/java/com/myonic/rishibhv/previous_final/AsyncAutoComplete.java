...
public class AsyncAutoComplete extends AsyncTask<String, Void, ArrayList<AutocompleteCity>> {
...
*/
    ...
    @Override
    protected void onPostExecute(ArrayList<AutocompleteCity> track) {
...
/*
    ...
    @Override
    protected ArrayList<AutocompleteCity> doInBackground(String... strings) {
        ...
        try {
            ...
            if (statuscpde == HttpURLConnection.HTTP_OK) {
                ...
                //    Thread.sleep(2000);
                return ParseSearchCity.TriviaJSONParser.parseQuestions(sb.toString());
